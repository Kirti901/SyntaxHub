...
const Home = () => {
  ...
  const getRunTimes = async () => {
    ...
    const options = [
      { label: "Python", value: "python", version: "3" },
      { label: "JavaScript", value: "javascript", version: "18" },
      { label: "C", value: "c", version: "10" },
      { label: "C++", value: "cpp", version: "10" },
      { label: "Java", value: "java", version: "15" }
    ];
